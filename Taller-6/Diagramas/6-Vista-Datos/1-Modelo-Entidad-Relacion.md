# Modelo Entidad-Relación (Nivel Físico/Lógico)

Este diagrama representa el modelo de datos subyacente que soporta la persistencia de Usuarios, Solicitudes, Productos, Suscripciones y Transacciones (Compras).
