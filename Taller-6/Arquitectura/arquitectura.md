...
Este documento describe la arquitectura del sistema E-Commerce Konrad usando el modelo de 4+1 vistas extendido con Vista de Datos.
...
**Fuera de alcance:** sistemas bancarios externos, infraestructura física de centros de datos.

## Glosario

| Término        | Definición                                                                                      |
| -------------- | ----------------------------------------------------------------------------------------------- |
| **CIFIN**      | Central de Información Financiera. Entidad colombiana que reporta historial crediticio.         |
| **DRP**        | Disaster Recovery Plan. Plan y centro de datos alterno para recuperación ante desastres.        |
| **FileSystem** | Sistema donde llegan archivos planos de CIFIN y consignaciones bancarias.                       |
...
| **SPA**        | Aplicación web que carga una sola página HTML y actualiza contenido dinámicamente.              |
...
| **AOP**        | Aspect-Oriented Programming. Separa concerns transversales del código de negocio.               |
...
_Figura 1 — Diagrama General de Casos de Uso_
...
![Figura 2 — Vista Lógica Nivel 1: Contenedores Base](images/logica-nivel1.png){height=7cm}

_Figura 2 — Vista Lógica Nivel 1: Contenedores Base_

## Nivel 2 — Componentes Internos y Protocolos

Muestra las capas internas de cada contenedor y los protocolos de comunicación.

![Figura 3 — Vista Lógica Nivel 2: Componentes y Protocolos](images/logica-nivel2.png){height=7cm}

_Figura 3 — Vista Lógica Nivel 2: Componentes y Protocolos_
...
![Figura 4 — Vista Lógica Nivel 3: Componentes Técnicos Detallados](images/logica-nivel3.png){height=10cm}

_Figura 4 — Vista Lógica Nivel 3: Componentes Técnicos Detallados_
...
![Figura 5 — Proceso: Registro de Vendedor y Aprobación](images/procesos-registro-vendedor.png){height=16cm}

_Figura 5 — Proceso: Registro de Vendedor y Aprobación_
...
![Figura 6 — Proceso: Compra de Productos](images/procesos-compra.png){height=19cm}

_Figura 6 — Proceso: Compra de Productos_
...
![Figura 7 — Proceso: Gestión de Solicitudes (Director Comercial)](images/procesos-director-comercial.png){height=19cm}

_Figura 7 — Proceso: Gestión de Solicitudes (Director Comercial)_
...
![Figura 8 — Vista Física: Topología de Despliegue Nivel 1](images/fisica-nivel1.png){height=18cm}

_Figura 8 — Vista Física: Topología de Despliegue Nivel 1_

## Topología Nivel 2 — Detalle Técnico

Detalla componentes internos de cada nodo y protocolos específicos (puertos TCP).

![Figura 9 — Vista Física: Topología de Despliegue Nivel 2 (Detalle Técnico)](images/fisica-nivel2.png){height=20cm}

_Figura 9 — Vista Física: Topología de Despliegue Nivel 2 (Detalle Técnico)_
...
![Figura 10 — Vista de Implementación: Estructura de Paquetes](images/implementacion.png){height=12cm}

_Figura 10 — Vista de Implementación: Estructura de Paquetes_
...
![Figura 11 — Modelo Entidad-Relación](images/datos-mer.png){height=11cm}

_Figura 11 — Modelo Entidad-Relación_
