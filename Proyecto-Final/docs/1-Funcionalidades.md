# Catálogo de Funcionalidades del Sistema PQRS

> Catálogo completo de funcionalidades identificadas para el sistema PQRS de SuperMarket. Separa funcionalidades **obligatorias del MVP** (12) de **mejoras opcionales post-MVP** (5).
