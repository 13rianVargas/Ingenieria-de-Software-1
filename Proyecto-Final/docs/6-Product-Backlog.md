...
> Backlog del Proyecto-Final PQRS. Una sola fuente de verdad para Historias de Usuario, estimaciones, prioridad, dependencias y sprint asignado. Alineado con [`1-Funcionalidades.md`](./1-Funcionalidades.md), [`2-MVP.md`](./2-MVP.md), [`4-Planning-Poker.md`](./4-Planning-Poker.md) y [`5-Capacidad-de-Equipo.md`](./5-Capacidad-de-Equipo.md).

## Historial de Versiones

| Versión | Fecha | Descripción Cambio |
| :--- | :--- | :--- |
| 01 | 13/05/2026 | Creación inicial: 12 HU en 3 sprints, estimaciones según Planning Poker original. |
| 02 | 19/05/2026 | Revisión preparación SPMP: reescritura completa para reconciliar el backlog con el resto del SPMP. (a) Sincronización de estimaciones con Planning Poker corregido (HU-04: 3→2, HU-07: 3→2, HU-08: 2→1). (b) Reducción de 3 a 2 sprints según `5-Capacidad-de-Equipo.md`. (c) Reasignación de HU-09 (Descargar Anexo) a Sprint 1 alineada con `2-MVP.md` v02. (d) Reasignación de HU-11 (Reporte PDF) y HU-12 (Notificación Confirmación) a sus sprints correctos según `2-MVP.md`. (e) Recálculo del resumen por sprint. (f) Suma de historial. |
