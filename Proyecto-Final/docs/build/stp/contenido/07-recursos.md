...
| Entregable | Descripción | Ubicacion |
|---|---|---|
...
| Evidencias de Ejecución | Capturas, logs, videos | Adjuntos en comentarios de cada Issue |
...
| Dispositivo móvil de prueba | Smartphone Android o iOS para validar la App Mobile |
...
| GitHub Actions | Validaciones automáticas del repositorio en CI (no ejecuta los TC funcionales, pero si lint, unit tests y build del software) |
...
- **Sobre el proceso:** los analistas deben conocer las plantillas test-case.yml y bug-report.yml, y el workflow en GitHub Projects (Backlog → Por ejecutar → En ejecución → Pass/Fail → Cerrado).
