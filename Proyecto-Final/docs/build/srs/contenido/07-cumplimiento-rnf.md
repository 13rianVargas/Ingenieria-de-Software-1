...
Esta sección mapea cada RNF a las decisiones arquitectónicas que lo materializan. El detalle completo de la arquitectura vive en el SAD (`9-Arquitectura-PQRS.md`).
